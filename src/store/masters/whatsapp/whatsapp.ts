...
import { whatsappAllContactInterface, whatsappAllPropertyInterface, whatsappAllDataInterface } from "./whatsapp.interface";
...
export const whatsappAllProperty = async (data: whatsappAllPropertyInterface) => {
  try {
