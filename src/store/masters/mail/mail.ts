...
import { mailAllContactInterface, mailAllPropertyInterface, mailAllDataInterface } from "./mail.interface";
...
export const emailAllProperty = async (data: mailAllPropertyInterface) => {
  try {

    console.log("emailall property data ", data)
