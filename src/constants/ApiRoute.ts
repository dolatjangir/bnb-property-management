export const BASE_URL = "https://apibnb.ibigdata.in/api";
//https://live-project-backend-1.onrender.com
//https://apibnb.ibigdata.in
...
export const API_ROUTES = {
  ...
  PROPERTY: {
    ...
    GET_FAVOURITES_PROPERTY: `${BASE_URL}/property/favouriteS/all`,
    GET_BY_ID: (id: string) => `${BASE_URL}/property/${id}`,
    GET_BY_PARAMS: (params: string) => `${BASE_URL}/property?${params}`,
    ADD: `${BASE_URL}/property`,
    UPDATE: (id: string) => `${BASE_URL}/property/${id}`,
    DELETE: (id: string) => `${BASE_URL}/property/${id}`,
    DELETEALL: `${BASE_URL}/property`,
    PROPERTYIMPORT: `${BASE_URL}/property/import`,
    PROPERTYEXCELHEADERS: `${BASE_URL}/property/import/headers`,
    ASSIGNPROPERTY: `${BASE_URL}/property/assign`
  },
  GUEST: {
    GET_ALL: `${BASE_URL}/guest`,
    GET_FAVOURITES_GUEST: `${BASE_URL}/guest/favouriteS/all`,
    GET_BY_ID: (id: string) => `${BASE_URL}/guest/${id}`,
    GET_BY_PARAMS: (params: string) => `${BASE_URL}/guest?${params}`,
    ADD: `${BASE_URL}/guest`,
    UPDATE: (id: string) => `${BASE_URL}/guest/${id}`,
    DELETE: (id: string) => `${BASE_URL}/guest/${id}`,
    DELETEALL: `${BASE_URL}/guest`,
    GUESTIMPORT: `${BASE_URL}/guest/import`,
    GUESTEXCELHEADERS: `${BASE_URL}/guest/import/headers`,
    ASSIGNGUEST: `${BASE_URL}/guest/assign`
  },
    FOODMENU: {
    GET_ALL: `${BASE_URL}/foodMenu`,
    GET_FAVOURITES_FOODMENU: `${BASE_URL}/foodMenu/favouriteS/all`,
    GET_BY_ID: (id: string) => `${BASE_URL}/foodMenu/${id}`,
    GET_BY_PARAMS: (params: string) => `${BASE_URL}/foodMenu?${params}`,
    ADD: `${BASE_URL}/foodMenu`,
    UPDATE: (id: string) => `${BASE_URL}/foodMenu/${id}`,
    DELETE: (id: string) => `${BASE_URL}/foodMenu/${id}`,
    DELETEALL: `${BASE_URL}/foodMenu`,
    FOODMENUIMPORT: `${BASE_URL}/foodMenu/import`,
    FOODMENUEXCELHEADERS: `${BASE_URL}/foodMenu/import/headers`,
    ASSIGNFOODMENU: `${BASE_URL}/foodMenu/assign`
  },
  COMPANYPROJECTS: {
  ...
  ALBUM: {
    GET_ALL: `${BASE_URL}/album`,
    GET_BY_ID: (id: string) => `${BASE_URL}/album/${id}`,
    GET_BY_PARAMS: (params: string) => `${BASE_URL}/album?${params}`,
    ADD: `${BASE_URL}/album`,
    UPDATE: (id: string) => `${BASE_URL}/album/${id}`,
    DELETE: (id: string) => `${BASE_URL}/album/${id}`,
  },
  TESTIMONIALS: {
    GET_ALL: `${BASE_URL}/testimonials`,
    GET_BY_ID: (id: string) => `${BASE_URL}/testimonials/${id}`,
    GET_BY_PARAMS: (params: string) => `${BASE_URL}/testimonials?${params}`,
    ADD: `${BASE_URL}/testimonials`,
    UPDATE: (id: string) => `${BASE_URL}/testimonials/${id}`,
    DELETE: (id: string) => `${BASE_URL}/testimonials/${id}`,
  },
  ...
  MASTERS: {
    ...
    PHOTOGALLERY: {
      GET_ALL: `${BASE_URL}/mas/photogallery`,
      GET_BY_ID: (id: string) => `${BASE_URL}/mas/photogallery/${id}`,
      GET_BY_PARAMS: (params: string) => `${BASE_URL}/mas/photogallery?${params}`,
      ADD: `${BASE_URL}/mas/photogallery`,
      UPDATE: (id: string) => `${BASE_URL}/mas/photogallery/${id}`,
      DELETE: (id: string) => `${BASE_URL}/mas/photogallery/${id}`,
    },
    FUNCTIONALAREA: {
    ...
    FLOOR: {
      GET_ALL: `${BASE_URL}/mas/floor`,
      GET_BY_ID: (id: string) => `${BASE_URL}/mas/floor/${id}`,
      GET_BY_PARAMS: (params: string) => `${BASE_URL}/mas/floor?${params}`,
      ADD: `${BASE_URL}/mas/floor`,
      UPDATE: (id: string) => `${BASE_URL}/mas/floor/${id}`,
      DELETE: (id: string) => `${BASE_URL}/mas/floor/${id}`,
    },
     MENUCATALOG: {
      GET_ALL: `${BASE_URL}/mas/menuCatalog`,
      GET_BY_ID: (id: string) => `${BASE_URL}/mas/menuCatalog/${id}`,
      GET_BY_PARAMS: (params: string) => `${BASE_URL}/mas/menuCatalog?${params}`,
      ADD: `${BASE_URL}/mas/menuCatalog`,
      UPDATE: (id: string) => `${BASE_URL}/mas/menuCatalog/${id}`,
      DELETE: (id: string) => `${BASE_URL}/mas/menuCatalog/${id}`,
    },
    MENUCATALOGTYPE: {
      GET_ALL: `${BASE_URL}/mas/menuCatalogType`,
      GET_BY_ID: (id: string) => `${BASE_URL}/mas/menuCatalogType/${id}`,
       GET_ALL_BY_MENUCATALOG: (id: string) => `${BASE_URL}/mas/menuCatalogType/menucatalog/${id}`,
      GET_BY_PARAMS: (params: string) => `${BASE_URL}/mas/menuCatalogType?${params}`,
      ADD: `${BASE_URL}/mas/menuCatalogType`,
      UPDATE: (id: string) => `${BASE_URL}/mas/menuCatalogType/${id}`,
      DELETE: (id: string) => `${BASE_URL}/mas/menuCatalogType/${id}`,
      DELETEALL: `${BASE_URL}/mas/menuCatalogType`,
    },
    HEAD: {
      GET_ALL: `${BASE_URL}/mas/head`,
      GET_BY_ID: (id: string) => `${BASE_URL}/mas/head/${id}`,
      GET_BY_PARAMS: (params: string) => `${BASE_URL}/mas/head?${params}`,
      ADD: `${BASE_URL}/mas/head`,
      UPDATE: (id: string) => `${BASE_URL}/mas/head/${id}`,
      DELETE: (id: string) => `${BASE_URL}/mas/head/${id}`,
    },
    ROOMTYPE: {
      GET_ALL: `${BASE_URL}/mas/roomtype`,
      GET_BY_ID: (id: string) => `${BASE_URL}/mas/roomtype/${id}`,
      GET_BY_PARAMS: (params: string) => `${BASE_URL}/mas/roomtype?${params}`,
      ADD: `${BASE_URL}/mas/roomtype`,
      UPDATE: (id: string) => `${BASE_URL}/mas/roomtype/${id}`,
      DELETE: (id: string) => `${BASE_URL}/mas/roomtype/${id}`,
    },
    PROPERTYFIELDS: {
      GET_ALL: `${BASE_URL}/mas/propertyFields`,
      GET_BY_ID: (id: string) => `${BASE_URL}/mas/propertyFields/${id}`,
      GET_BY_PARAMS: (params: string) => `${BASE_URL}/mas/propertyFields?${params}`,
      ADD: `${BASE_URL}/mas/propertyFields`,
      UPDATE: (id: string) => `${BASE_URL}/mas/propertyFields/${id}`,
      DELETE: (id: string) => `${BASE_URL}/mas/propertyFields/${id}`,
    },
  ...
  SETTINGS: {
    PROPERTYFIELDLABEL: {
      GET_ALL: `${BASE_URL}/propertyfieldlabels`,
      UPDATE: `${BASE_URL}/propertyfieldlabels`,
    }
  },
  ROOM: {
    ROOMS: {
      GET_ALL: `${BASE_URL}/room`,
      GET_BY_ID: (id: string) => `${BASE_URL}/room/${id}`,
      GET_BY_PARAMS: (params: string) => `${BASE_URL}/room?${params}`,
      ADD: `${BASE_URL}/room`,
      UPDATE: (id: string) => `${BASE_URL}/room/${id}`,
      DELETE: (id: string) => `${BASE_URL}/room/${id}`,
      DELETEALL: `${BASE_URL}/room`,
    },
    ROOMALLOTMENT: {
      GET_ALL: `${BASE_URL}/roomAllotment`,
      GET_BY_ID: (id: string) => `${BASE_URL}/roomAllotment/${id}`,
      GET_BY_PARAMS: (params: string) => `${BASE_URL}/roomAllotment?${params}`,
      ADD: `${BASE_URL}/roomAllotment`,
      UPDATE: (id: string) => `${BASE_URL}/roomAllotment/${id}`,
      DELETE: (id: string) => `${BASE_URL}/roomAllotment/${id}`,
      DELETEALL: `${BASE_URL}/roomAllotment`,
    }
  },
  FINANCIAL: {
    INCOMEMARKETING: {
    ...
    GUESTBILLING: {
      GET_ALL: `${BASE_URL}/guestBilling`,
      GET_BY_ID: (id: string) => `${BASE_URL}/guestBilling/${id}`,
      GET_BY_PARAMS: (params: string) => `${BASE_URL}/guestBilling?${params}`,
      ADD: `${BASE_URL}/guestBilling`,
      UPDATE: (id: string) => `${BASE_URL}/guestBilling/${id}`,
      DELETE: (id: string) => `${BASE_URL}/guestBilling/${id}`,
    }
  },
  FAVOURITES: {
