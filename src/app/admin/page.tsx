      ...
      <div className=" flex flex-col justify-between  items-center w-full max-lg:bg-[url('/loginbg.png')] max-lg:bg-cover max-lg:bg-center max-lg:bg-no-repeat min-h-full bg-white max-lg:text-white max-lg:bg-linear-to-b max-lg:from-[var(--color-primary)] max-lg:to-fuchsia-900 px-1  ">
        <div className=" self-start  w-full px-5 py-5">
          <div className="  lg:hidden">
            <div className=" relative">
              <h2 className="  font-bold text-2xl"><span className=" text-[var(--color-primary-lighter)]">BNB</span></h2> 
               <p className=" absolute top-0  left-[52px] text-[8px] rounded-xl text-[var(--color-primary-lighter)] font-normal border border-[var(--color-primary-lighter)] px-[5px] py-[1px]">Property</p>
            </div>
          <p className=" text-[var(--color-primary-light)] text-sm font-light mt-1">Property Management Solution</p>
          </div>
        ...
        <div className=" text-[var(--color-primary-light)] text-sm my-10">&copy;{currentYear} BNB Property Management, all rights reserved </div>
      </div>
