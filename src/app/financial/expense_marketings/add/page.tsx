          ...
          <form onSubmit={(e) => e.preventDefault()} className="w-full">
            ...
            <div className="flex flex-col space-y-6">
              <div className="grid grid-cols-2 gap-6 max-lg:grid-cols-1">
                ...
                <SingleSelect
                  options={Array.isArray(fieldOptions?.Head) ? fieldOptions.Head : []}
                  label="Head"
                  value={expenseData.Head}
                  onChange={(v) => handleSelectChange("Head", v)}
                />
                <SingleSelect
                ...
                />
                 <TextareaField label={"Description"} name="Description" value={expenseData.Description} onChange={handleInputChange} />
              </div>
