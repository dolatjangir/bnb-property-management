              ...
              <table className="table-auto w-full border-collapse text-sm border border-gray-200">
                <thead className="bg-[var(--color-primary)] text-white">
                  <tr>
                    ...
                    <th className="px-4 py-3 border border-[var(--color-secondary-dark)] text-left">Head</th>
                    <th className="px-4 py-3 border border-[var(--color-secondary-dark)] text-left">Expense</th>
                    <th className="px-4 py-3 border border-[var(--color-secondary-dark)] text-left">Pay Amount</th>
                  ...
                  {currentRows.length > 0 ? (
                    currentRows.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 border border-gray-200">{item.Head}</td>
