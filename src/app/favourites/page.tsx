...
import {
  propertyGetDataInterface,
  DeleteDialogDataInterface,
} from "@/store/property.interface";
import {
  deleteProperty,
  getFavoutiteProperty,
  updateProperty,
} from "@/store/property";
...
export default function FavouritePage() {
  ...
  const [favouriteData, setFavouriteData] = useState<propertyGetDataInterface[]>([]);
  ...
  const getFavouriteData = async () => {
    const data = await getFavoutiteProperty();
  ...
  return (
    <ProtectedRoute>
      ...
      />
      {/* mobile screen */}
      <div className=" sm:hidden min-h-[calc(100vh-56px)] overflow-auto  ">
        <FavouriteTable
          leads={favouriteData}
              ...
              <table className="table-auto w-full border-collapse text-sm border border-gray-200">
                <thead className="bg-[var(--color-primary)] text-white">
                  <tr>
                    ...
                    <th className="px-4 py-3 border border-[var(--color-secondary-dark)] text-left">Property Subtype</th>
